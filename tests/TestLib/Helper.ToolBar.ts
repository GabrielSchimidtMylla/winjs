...
module Helper.ToolBar {
    ...
    export function verifyToolBarRenderedOpened(toolBar: WinJS.UI.PrivateToolBar): void {
        ...
        Helper._CommandingSurface.verifyCommandingSurfaceRenderedOpened(toolBar._commandingSurface);
    }

    export function verifyToolBarRenderedClosed(toolBar: WinJS.UI.PrivateToolBar): void {
        var toolBarRect = toolBar.element.getBoundingClientRect();
        var commandingSurfaceRect = toolBar._dom.commandingSurfaceEl.getBoundingClientRect();
        var placeHolder = toolBar._dom.placeHolder;
        ...
        Helper._CommandingSurface.verifyCommandingSurfaceRenderedClosed(toolBar._commandingSurface);
    }
