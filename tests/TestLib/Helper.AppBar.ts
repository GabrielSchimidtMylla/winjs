...
module Helper.AppBar {
    ...
    export function verifyAppBarRenderedOpened(appBar: WinJS.UI.PrivateAppBar): void {
        ...
        Helper._CommandingSurface.verifyCommandingSurfaceRenderedOpened(appBar._commandingSurface);
    }

    export function verifyAppBarRenderedClosed(appBar: WinJS.UI.PrivateAppBar): void {
        ...
        Helper._CommandingSurface.verifyCommandingSurfaceRenderedClosed(appBar._commandingSurface);
    }
